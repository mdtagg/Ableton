  ...
  return (
    <>
      ...
      <main>
        ...
        <div id="first-video">
          <iframe width="100%" height="100%" frameBorder="0" src="https://www.youtube.com/embed/VSPYMRurohc?si=09_Woy0KO7efEwiq" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        ...
        <div className="background-container">
          <div id="left-image-container" className="color-image-container">
              <img
                  src="/src/assets/pexels-blaz-erzetic-2426085.jpg"
                  width="80%"
                >
                </img>
                <img
                  src="/src/assets/pexels-lukas-590041.jpg"
                  height="50%"
                  width="80%"
                >
                </img>
            ...
            <div className="image-container  adjust-right">
              <img
                src="/src/assets/pexels-djordje-petrovic-2102416.jpg"
                height="100%"
                width="80%"
              ></img>
          </div>
